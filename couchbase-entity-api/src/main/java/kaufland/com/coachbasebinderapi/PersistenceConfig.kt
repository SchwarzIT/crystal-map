...
object PersistenceConfig {
    ...
    interface Connector {
        ...
        fun getDocument(id: String, dbName: String, reduce: List<String> = emptyList()): Map<String, Any>?
        fun getDocuments(ids: List<String>, dbName: String, reduce: List<String> = emptyList()): List<Map<String, Any>?>
        fun queryDoc(dbName: String, queryParams: Map<String, Any>, limit: Int? = null, reduce: List<String> = emptyList()): List<Map<String, Any>>
    ...
    interface SuspendingConnector {
        ...
        suspend fun getDocument(id: String, dbName: String, reduce: List<String> = emptyList()): Map<String, Any>?

        suspend fun getDocuments(ids: List<String>, dbName: String, reduce: List<String> = emptyList()): List<Map<String, Any>>

        suspend fun queryDoc(dbName: String, queryParams: Map<String, Any>, limit: Int? = null, reduce: List<String> = emptyList()): List<Map<String, Any>>
