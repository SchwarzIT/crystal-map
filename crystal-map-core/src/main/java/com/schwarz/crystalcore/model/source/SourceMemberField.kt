...
data class SourceMemberFunction(val name: String, val isSuspend: Boolean, val returnTypeName: TypeName, val parameters: List<Parameter>, val docIdSegment: ISourceDocIdSegment?, val generateAccessor: ISourceGenerateAccessor?)
