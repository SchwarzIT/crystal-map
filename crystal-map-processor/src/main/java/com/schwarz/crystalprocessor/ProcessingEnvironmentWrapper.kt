...
class ProcessingEnvironmentWrapper(
    ...
    override val documentationFilename: String? =
        processingEnvironment.options[CoachBaseBinderProcessor.FRAMEWORK_DOCUMENTATION_FILENAME_OPTION_NAME]
    ...
    override val entityRelationshipPath: String? =
        processingEnvironment.options[CoachBaseBinderProcessor.FRAMEWORK_ENTITY_RELATIONSHIP_PATH_OPTION_NAME]
    override val entityRelationshipFilename: String? =
        processingEnvironment.options[CoachBaseBinderProcessor.FRAMEWORK_ENTITY_RELATIONSHIP_FILENAME_OPTION_NAME]
}
